    ...
    if (modal) {
        ...
        serviceLinks.forEach((link, index) => {
            link.addEventListener('click', (e) => {
                ...
                modalDesc.innerText = text + ' Sua instalação elétrica está segura e dentro da norma? A Adequação Elétrica é o processo de revisão e correção de toda a instalação para atender as exigências da NBR 5410 e NR-10. O objetivo é eliminar riscos, garantir o funcionamento correto e trazer conformidade legal para sua empresa. Nosso serviço inclui: - Laudo e Diagnóstico Técnico: Inspeção completa para identificar não conformidades;
                ...
                - Emissão de Documentação: ART e Relatório Fotográfico.
                Nossa equipe está pronta para avaliar sua necessidade e propor a melhor solução técnica. Fale conosco para um orçamento sem compromisso!';
